                ...
                <ul className='homepage-categories'>
                    <li>
                        <a href='/productos/colchones/' title='Colchones | Kamas'>
                            <div>
                                ...
                                src={`/assets/imagenes/paginas/pagina-principal/categorias/${isSmallScreen ? 'thumb/' : ''}1.webp`} />
                            </div>
                    ...
                    <li>
                        <a href='/productos/camas-box-tarimas/' title='Camas box tarimas | Kamas'>
                            <div>
                                <img width={isSmallScreen ? 80 : 160} height={isSmallScreen ? 80 : 160} loading="lazy"
                                src={`/assets/imagenes/paginas/pagina-principal/categorias/${isSmallScreen ? 'thumb/' : ''}2.webp`} />
                            </div>
                    ...
                    <li>
                        <a href='/productos/dormitorios/' title='Dormitorios | Kamas'>
                            <div>
                                <img width={isSmallScreen ? 80 : 160} height={isSmallScreen ? 80 : 160} loading="lazy"
                                src={`/assets/imagenes/paginas/pagina-principal/categorias/${isSmallScreen ? 'thumb/' : ''}3.webp`} />
                            </div>
                    ...
                    <li>
                        <a href='/productos/camas-funcionales/' title='Camas funcionales | Kamas'>
                            <div>
                                <img width={isSmallScreen ? 80 : 160} height={isSmallScreen ? 80 : 160} loading="lazy"
                                src={`/assets/imagenes/paginas/pagina-principal/categorias/${isSmallScreen ? 'thumb/' : ''}4.webp`} />
                            </div>
                    ...
                    <li>
                        <a href='/productos/cabeceras/' title='Cabeceras | Kamas'>
                            <div>
                                <img width={isSmallScreen ? 80 : 160} height={isSmallScreen ? 80 : 160} loading="lazy"
                                src={`/assets/imagenes/paginas/pagina-principal/categorias/${isSmallScreen ? 'thumb/' : ''}5.webp`} />
                            </div>
                    ...
                    <li>
                        <a href='/productos/sofas/' title='Sofás | Kamas'>
                            <div>
                                <img width={isSmallScreen ? 80 : 160} height={isSmallScreen ? 80 : 160} loading="lazy"
                                src={`/assets/imagenes/paginas/pagina-principal/categorias/${isSmallScreen ? 'thumb/' : ''}7.webp`} />
                            </div>
