            ...
            <section className='block-content'>
                ...
                <div className='d-grid-2-1fr gap-10'>
                    ...
                    <div className='d-flex-column gap-5'>
                        ...
                        <p className='text'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry of type and scrambled it to make a type specimen book. It has survived not only five centuries</p>
                        ...
                        <p className='text'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy a type specimen book. It has survived not only five centuries</p>
