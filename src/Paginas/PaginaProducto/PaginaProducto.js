...
function PaginaProducto(){
    ...
    // Calcular fecha de validez (1 año a partir de hoy)
    ...
    const productSchema = {
        ...
        // Eliminado aggregateRating por falta de reseñas reales
        "offers": {
            "@type": "Offer",
            "url": `https://kamas.pe${producto.ruta}`,
            "priceCurrency": "PEN",
            "price": cleanPrice(producto.precioVenta), // Precio limpio
            "priceValidUntil": getValidUntilDate(), // Fecha dinámica
            "itemCondition": "https://schema.org/NewCondition",
            "availability": producto.stock > 0 ? "https://schema.org/InStock" : "https://schema.org/OutOfStock"
        }
    };
