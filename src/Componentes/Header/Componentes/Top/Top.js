                ...
                <ul className='header-top-left d-flex-center-left gap-10'>
                    ...
                    <li className='d-flex-center-center gap-5'>
                        ...
                        <ul className='d-flex-center-left gap-5'>
                            ...
                            <li>
                                <a href='mailto: atencion-al-cliente@kamas.pe' title="" className='d-flex-center-center gap-5'>
                                    <img src="/assets/imagenes/iconos/correo-gris.svg" alt="Correo electrónico | Kamas" />
                                    <h2>atencion-al-cliente@kamas.pe</h2>
                                </a>
                            </li>
                        </ul>
                    </li>
